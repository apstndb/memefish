...
var lexerTestCases = []struct {
	...
	{`"\xff"`, []*Token{{Kind: TokenString, Raw: `"\xff"`, AsString: "ÿ"}}},
	{`"\377"`, []*Token{{Kind: TokenString, Raw: `"\377"`, AsString: "ÿ"}}},
	{`"\xc3\xa9"`, []*Token{{Kind: TokenString, Raw: `"\xc3\xa9"`, AsString: "Ã©"}}},
	{"`\\xff`", []*Token{{Kind: TokenIdent, Raw: "`\\xff`", AsString: "ÿ"}}},
	{"`\\377`", []*Token{{Kind: TokenIdent, Raw: "`\\377`", AsString: "ÿ"}}},
	{`b"\xff\377"`, []*Token{{Kind: TokenBytes, Raw: `b"\xff\377"`, AsString: "\xff\xff"}}},
