...
func (g *GQLElementPatternFiller) Pos() token.Pos {
	return nodePos(nodeChoice(wrapNode(g.Hint), wrapNode(g.Variable), wrapNode(g.Label), wrapNode(g.Properties), wrapNode(g.Where), wrapNode(g.Cost)))
}

func (g *GQLElementPatternFiller) End() token.Pos {
	return nodeEnd(nodeChoice(wrapNode(g.Cost), wrapNode(g.Where), wrapNode(g.Properties), wrapNode(g.Label), wrapNode(g.Variable), wrapNode(g.Hint)))
}
